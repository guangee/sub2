...
<template>
  <div>
    <button style="position:absolute;right:100px" type="button" class="btn btn-primary"v-on:click="getPdf()">导出PDF</button>
  <div class="row" id="pdfDom" style="padding-top: 10px;background-color:#fff;">
    <Form ref="boilerForm" label-position="left" :model="formList" :rules="ruleformList" class="form-wrapper" :label-width="100">
      ...
      <Form :model="formList" label-position="right" :label-width="100">
        <Row>
          <Col span="11" offset="13">
            <FormItem label="编号" >
              <Input readonly="true" v-model="formList.serialNo"  placeholder="请输入编号"   style="width: 333px"  ></Input>
            </FormItem>
          </Col>
        </Row>
      </Form>
      <Row>
        <Col span='11'>
          <FormItem label="制造单位名称" prop="MFname">
            <Input readonly="true" v-model="formList.corpnName" placeholder="请输入制造单位名称"></Input>
          </FormItem>
          <FormItem label="单位负责人" prop="principal">
            <Input readonly="true" v-model="formList.prinpal" placeholder="请输入单位负责人名字"></Input>
          </FormItem>
          ...
          <FormItem label="评审机构名称">
            <Input readonly="true" v-model="formList.eiName" placeholder="请输入评审机构名称"></Input>
          </FormItem>
          <FormItem label="监督检验机构">
            <Input readonly="true" v-model="formList.supervisionOrg" placeholder="请输入监督检验机构"></Input>
          </FormItem>
        </Col>
        <Col span='11' offset='2'>
          <FormItem label="制造单位地址">
            <Input readonly="true" v-model="formList.mfAdd" placeholder="请输入制造单位地址"></Input>
          </FormItem>
          <FormItem label="联系电话">
            <Input readonly="true" v-model="formList.phoneNo" placeholder="请输入负责人联系电话"></Input>
          </FormItem>
          <Row>
            <Col span='12'>
              <FormItem label="许可范围">
                <Input readonly="true" v-model="formList.licenseRange" placeholder="请输入许可范围"></Input>
              </FormItem>
            </Col>
            <Col span='12'>
              <Form :model="formList" label-position="right" :label-width="90">
              <FormItem label="许可证有效期">
                <Input readonly="true" v-model="formList.licenseDate" placeholder="请输入许可证有效期"></Input>
              </FormItem>
              </Form>
            </Col>
          </Row>
          <FormItem label="最近一次评审日">
            <Input readonly="true" v-model="formList.lastDate" placeholder="请输入最近一次评审日期"></Input>
          </FormItem>
          <FormItem label="监督检查人">
            <Input readonly="true" v-model="formList.supervisor" placeholder="监督检查人"></Input>
          </FormItem>
        </Col>
      </Row>
      ...
      <Row>
        <Col span='11'>
          <FormItem label="监督检查人员" >
            <Input readonly="true" v-model="formList.checker_1" placeholder="请输入监督检查人员"></Input>
          </FormItem>
        </Col>
        <Col span='11' offset='2'>
          <FormItem label="日期">
      ...
      <Row>
        <Col span='11'>
          <FormItem label="监督检查人员">
            <Input readonly="true" v-model="formList.checker_2" placeholder="请输入监督检查人员"></Input>
          </FormItem>
        </Col>
        <Col span='11' offset='2'>
          <FormItem label="日期">
      ...
      <Row>
        <Col span='11'>
          <FormItem label="监督检查人员">
            <Input readonly="true" v-model="formList.checker_3" placeholder="请输入监督检查人员"></Input>
          </FormItem>
        </Col>
        <Col span='11' offset='2'>
          <FormItem label="日期">
      ...
      <Row>
        <Col span='11'>
          <FormItem label="监督检查人员">
            <Input readonly="true" v-model="formList.checker_4" placeholder="请输入监督检查人员"></Input>
          </FormItem>
        </Col>
        <Col span='11' offset='2'>
          <FormItem label="日期">
